//
//  ToProfileTransitionAnimator.swift
//  OneSoundV2Demo
//
...
class ToProfileTransitionAnimator: NSObject {
    weak var transitionContext: UIViewControllerContextTransitioning?
   
}

extension ToProfileTransitionAnimator: UIViewControllerAnimatedTransitioning {
